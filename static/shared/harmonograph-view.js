 ...
 * ====================
 * Experimental fork of resonance-view.js that powers the /harmonograph
 * route. This file is where upcoming visualization features — grid
 * motion, chord merging, hidden-controls fullscreen UX, share links —
 * will land. The canonical Explorer "Resonance" tab continues to use
 * static/shared/resonance-view.js; that file must stay untouched while
 * this fork evolves.
 *
 ...
 *
 * Exposes: class HarmonographView { init, setAnalyser, start, stop, destroy }
 *
...
export class HarmonographView {
  ...
  init(containerId) {
    ...
    this.canvas.className = 'sl-harmonograph-canvas';
...
HarmonographView.DEFAULT_PARAMS = DEFAULT_PARAMS;

export { DEFAULT_PARAMS };
export default HarmonographView;
